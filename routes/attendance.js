...
import { addAttendance, getAttendanceByDate, toggleAttendance, getAttendanceByCycle, getMyAttendanceCycle, getActivityMap } from "../controllers/attendance.js"

router.get("/my-cycle", protect, /* #swagger.tags = ['Attendance'] */ getMyAttendanceCycle)
router.get("/activity-map", protect, adminOnly, /* #swagger.tags = ['Attendance'] */ getActivityMap)
